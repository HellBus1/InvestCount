...
const LPSSection = () => {
  ...
  return (
    ...
    >
      <div className='max-w-7xl mx-auto px-4 md:px-8 mx-4 md:mx-10 lg:mx-20'>
        {/* Main Content */}
        ...
        >
          {rates.map((item, index) => (
            <motion.div
              key={index}
              className='relative bg-white border-2 border-charter-blue-200 rounded-2xl p-6 md:p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group'
              variants={childVariants}
